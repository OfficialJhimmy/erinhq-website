...
const projects = [
  {
    title: "Refactrd",
    description:
      "An AI engineering studio I co-founded, helping startups and enterprise teams move from AI experimentation to workflow transformation and measurable operational impact.",
    link: "https://refactrd.com",
    image: "/images/refactrd-cover.png",
  },
  {
    title: "Melly Guard",
    description:
      "An AI-driven fraud detection and AML monitoring platform used by several banks in Nigeria, built with real-time detection and explainable AI outputs for regulatory acceptance.",
    link: "/portfolio/melly-guard",
    image: "/images/fraud-detection.png",
  },
  {
    title: "Datamellon",
    description:
      "Datamellon is a cloud-native software development and AI consulting company with operations across the UK, Nigeria, Ghana, Kenya, USA, Canada, Uganda, South Africa, Dubai, and Saudi Arabia.",
    link: "https://datamellon.com",
    image: "/images/datamellon-cover.png",
  },
];
