...
const testimonials: Testimonial[] = [
  {
    name: 'Oyin Dawodu',
    role: 'Founder and CEO, Refactrd',
    avatar: '/images/Avatar.svg',
    rating: 5,
    testimonial: "Feyijimi is the reason Refactrd can promise clients technical depth and not just strategy. He moves fast without cutting corners, and when a client's requirements get complicated halfway through a build, he is usually the one who finds the cleanest way through it rather than the easiest one. Beyond the engineering, he thinks about the business side of what we are building, which makes him easy to plan around as a co-founder rather than just an engineer I hand things off to."
  },
  {
