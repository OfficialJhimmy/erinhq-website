        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-14 sm:h-16 lg:h-20">
            ...
            <a
              ...
              onClick={() => trackButtonClick('Hero CTA - Get in Touch')}
              className="hidden lg:inline-flex items-center gap-2 text-white border-b-2 border-white pb-1 font-medium hover:border-orange-400 hover:text-orange-400 transition-all hover:gap-3 cursor-pointer"
            >
            ...
            {isMinimalMode && (
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => trackButtonClick('Hero CTA - Get in Touch')}
                className="lg:hidden inline-flex items-center gap-2 text-white border-b-2 border-white pb-1 font-medium hover:border-orange-400 hover:text-orange-400 transition-all hover:gap-3 cursor-pointer text-sm"
              >
