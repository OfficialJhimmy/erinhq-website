...
export const projects: Project[] = [
  
  {
    ...
    shortDescription:
      "The marketing site for Refactrd, an AI transformation studio, built to move visitors from problem recognition to a clear next step.",
    fullDescription:
    ...
    year: "2026",
    liveUrl: "https://refactrd.com",
    client: "Refactrd",
    role: "Lead Engineer",
    challenges:
      "Refactrd's offering sits between consulting and software delivery, which made it easy for the site to read as either a generic dev agency or an abstract strategy firm. The build needed a structure that could hold the diagnostic language of the brand, workflow transformation, adoption problems, operational impact, alongside a working case study and insights section without turning into a wall of text.",
    solutions: [
      "Built the page around a problem, then transformation areas, then proof structure, so visitors land on a single next action instead of several competing calls to action",
      "Implemented a case studies and insights section that can be updated independently as the studio publishes new work, backed by a lightweight content structure rather than a full CMS",
      "Used consistent section level components across the four transformation areas so new services can be added without redesigning the page",
      "Tuned performance and image loading since the site leans on visuals over long paragraphs to communicate abstract concepts quickly",
    ],
    results:
  ...
  },
   {
    ...
    shortDescription:
      "The event site for Startups Blueprint, a curated roundtable for women leaders building AI powered African startups, built to drive qualified applications rather than open registration.",
    fullDescription:
    ...
    technologies: ["Next.js", "TypeScript", "Tailwind CSS"],
    year: "2026",
    liveUrl: "https://startupsblueprint.africa",
    client: "Startups Blueprint",
    role: "Lead Frontend Engineer",
    challenges:
      "The event needed to read as exclusive and credible rather than like a generic conference landing page, while still giving enough concrete detail, agenda, speakers, partnership tiers, for a founder to decide quickly whether to apply. Balancing sponsor visibility with the event's core audience of founders was also a constraint, since the site serves both applicants and partners at once.",
    solutions: [
      "Built a speaker and agenda structure that leads with credibility, who is in the room and what you'll walk away with, before asking for an application",
      "Added a dedicated partnership section with tiered sponsor benefits, kept clearly separate from the founder facing application flow",
      "Connected the application flow to the event's external registration system so the site stays lightweight while still capturing qualified applicants",
      "Used the same section pacing across the site, problem, proof, agenda, call to action, since the client runs multiple events under this structure",
    ],
    results:
      "The site gives the event a credible, self contained home that a founder can review in a few minutes and decide whether to apply, without needing a follow up call just to explain what the event is.",
  },
  {
    id: "sift-academy",
    title: "Sift Academy: Career Growth Membership Platform",
    shortDescription:
      "A membership site for Sift Academy that turns a subscription based career development program into a clear, conversion focused experience.",
    fullDescription:
    ...
    technologies: ["Next.js", "TypeScript", "Tailwind CSS"],
    year: "2026",
    liveUrl: "https://siftacademy.com",
    client: "Sift Academy",
    role: "Lead Software Engineer",
    challenges:
      "The membership has a lot of moving parts, live sessions, resource packs, a six month milestone journey, founding member pricing, and the site needed to present all of it without becoming a features list nobody reads. It also needed a pricing section that could switch between a standard tier and a limited time founding member offer without confusing visitors.",
    solutions: [
      "Built a month by month journey section so the six month membership arc reads as a story rather than a bullet list of features",
      "Structured the membership benefits into a visual grid so the size of what's included is clear at a glance instead of buried in paragraphs",
      "Implemented a founding member pricing state that can be swapped to standard pricing once the limited offer closes",
      "Kept the page performant despite heavy section imagery, since most traffic is expected to arrive from Instagram and referral links on mobile",
    ],
    results:
 ...
 
  {
    ...
    testimonial: {
      text: "Erin’s full-stack expertise and deep understanding of AI systems were crucial in delivering a high-performance fraud detection platform. The system is fast, reliable, and has made a measurable impact on our operations.",
      author: "Chief Risk Officer",
      position: "Leading Nigerian Bank",
    },
  },
  {
    id: "dls-travel-and-consult",
    title: "DLS Travel and Consult: Study and Relocation Platform",
    shortDescription:
      "A responsive relocation and visa consulting website that helps ambitious Africans plan study, work, and family relocation journeys across Europe.",
    fullDescription:
    ...
    year: "2026",
    liveUrl: "https://dlstravelsandconsults.com",
    client: "DLS Travel and Consult",
    role: "Lead Frontend Engineer",
    challenges:
      "The site needed to build trust quickly with visitors making a major life decision, present five different program pathways without overwhelming them, and support both European and African audiences, all while keeping the path to a booked consultation frictionless.",
    solutions: [
      "Structured country and program pages around a single consultation, processing, and travel journey so visitors always know where they are in the process",
      "Built a language switcher covering the European and African languages relevant to the client base",
      "Integrated a direct booking flow to the consultation calendar, removing the back and forth over email or WhatsApp",
      "Added a testimonial section organized by program type so prospective clients see proof relevant to their specific goal, whether study, work, or family reunification",
      "Optimized image loading and layout for mobile, since most inbound traffic arrives through Instagram and WhatsApp links",
    ],
    results:
      "The site now serves as the primary conversion point for a company that has relocated more than 70 students and reunified over 20 families across 12 countries. Visitors can go from landing on the homepage to booking a paid consultation in a few clicks instead of a lengthy back and forth.",
  },
  {
    ...
    testimonial: {
      text: "This project showcases Erin’s ability to design and implement real-time AI-driven systems. The contract generator is fast, reliable, and produces high-quality outputs, demonstrating strong full-stack engineering and AI integration skills.",
      author: "Self-Review",
  ...
  },
  {
    ...
    testimonial: {
      text: "ERIN’s leadership and frontend expertise were instrumental in bringing the Melly AI Suite to life. The interfaces are seamless, responsive, and highly interactive, enabling our AI products to deliver real business impact across multiple industries.",
  ...
  },
  {
    ...
    testimonial: {
      text: "ERIN delivered a robust, user-friendly portal that transformed how we manage property transactions. The platform is fast, secure, and easy for both our citizens and admin teams to use.",
  ...
  },
  {
    ...
    testimonial: {
      text: "ERIN’s frontend expertise elevated KlaudWorks to a world-class SaaS experience. The dashboard is intuitive, fast, and visually engaging, making complex cloud financial data easy to understand and act upon.",
  ...
  },
  {
    ...
    testimonial: {
      text: "This project highlights Erin’s ability to integrate frontend and backend technologies in a real-world browser extension. The extension is efficient, reliable, and user-friendly, showcasing expertise in React, FastAPI, and Chrome Extension development.",
      author: "Self-Review",
      position: "Full Stack Developer",
    },
  },
  ...
  },
  {
    ...
    testimonial: {
      text: "ERIN transformed our vision into a powerful, modern platform. The website is easy to manage, visually appealing, and truly captures the essence of WriteTech Hub’s mission. Our clients now enjoy a smooth and professional experience.",
  ...
  },
  {
    ...
    testimonial: {
      text: "ERIN’s frontend expertise brought SongDis to life. The dashboards are intuitive, fast, and professional. Our global artists and publishers love the platform, and it has set a new standard for music distribution user experience.",
  ...
  },
  {
    ...
    testimonial: {
      text: "As a founding engineer, ERIN brought technical vision, leadership, and execution to Shestel. The platform’s performance, scalability, and user experience reflect his deep expertise and commitment to building world-class systems.",
      author: "Shestel CTO",
      position: "Chief Technology Officer",
    },
  },
  {
    ...
    testimonial: {
      text: "ERIN built a platform that transformed how we reach and engage with our learners. The website is intuitive, fast, and visually impressive, making registration and payments effortless. His technical expertise and attention to detail are exceptional.",
  ...
  },
  {
    ...
    testimonial: {
      text: "ERIN developed a website that perfectly reflects our professionalism and expertise. The CMS allows our team to manage content with ease, and the overall design enhances user engagement and SEO performance.",
      author: "David Olivia",
