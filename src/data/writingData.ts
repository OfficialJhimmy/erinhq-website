...
export const articles: Article[] = [
  ...
  },
  {
    ...
    image: '/images/vscode-extensions.webp',
    readTime: '5 min read',
  ...
  },
  {
    ...
    linkText: 'Read more',
    category: ['blogs', 'tutorials', 'openSource'],
  ...
  {
    id: 'making-ai-tools-human-friendly',
    title: 'Making AI Tools More Human-Friendly',
    description: 'A reflection on building AI that\'s not just powerful, but also usable and fun',
    image: '/images/ai-tools-blog.jpg',
    readTime: '5 min read',
    link: '#',
    linkText: 'Read more',
    category: ['blogs'],
  ...
  // Case Studies
  {
    ...
    image: '/images/crc-case-study.webp',
    readTime: '6 min read',
    link: 'https://datamellon.com/crc-case-study',
    linkText: 'Read more',
  ...
  {
    id: 'scaling-b2b-saas-platform',
    title: 'Scaling a B2B SaaS Platform for 500+ Users',
    description: 'Documented how I optimized backend performance and improved adoption rates',
    image: '/images/b2b-saas-blog.jpg',
    readTime: '5 min read',
    link: '#',
    linkText: 'Read more',
    category: ['caseStudies'],
  ...
  // API Documentation & Specialization
  {
    ...
    linkText: 'Read more',
    category: ['apiDocs', 'specialization'],
  ...
  },
  {
    ...
    description: 'Setting up and managing AWS Control Tower for multi-account environments',
    image: '/images/control-tower.webp',
    readTime: '12 min read',
    link: 'https://datamellon.com/controltower',
    linkText: 'Read more',
    category: ['apiDocs', 'specialization'],
    tags: ['Control Tower', 'AWS', 'Governance'],
    companyName: 'Datamellon',
    featured: false,
  ...
  },
  {
    ...
    description: 'Infrastructure as Code solutions using AWS CloudFormation',
    image: '/images/cloudformation.webp',
    readTime: '9 min read',
    link: 'https://datamellon.com/aws-cloudformation',
    linkText: 'Read more',
    category: ['apiDocs', 'specialization'],
  ...
  },
  {
    ...
    description: 'Building and managing APIs with AWS API Gateway',
    image: '/images/api-gateway.webp',
    readTime: '11 min read',
    link: 'https://datamellon.com/aws-api-gateway',
    linkText: 'Read more',
    category: ['apiDocs', 'specialization'],
    tags: ['API Gateway', 'AWS', 'APIs'],
    companyName: 'Datamellon',
    featured: false,
    publishedDate: '2023-12-01',
  },
  {
    id: 'restful-api-documentation',
    title: 'RESTful API Documentation',
    description: 'Complete guide to implementing and documenting REST APIs',
    image: '/images/api-doc-1.jpg',
    readTime: '5 min read',
    link: '#',
    linkText: 'Read more',
    category: ['apiDocs'],
    tags: ['REST API', 'Documentation', 'Best Practices'],
    featured: false,
