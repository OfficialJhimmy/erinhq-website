...
export const articles: Article[] = [
  ...
  {
    id: 'engaging-video',
    title: 'How to Create Engaging Video Tutorials for Technical Content',
    description: 'Want to create engaging video tutorials for technical content? Learn how to craft clear, concise, and impactful tutorials with expert tips on scripting, pacing, visuals, and editing. Plus, discover essential tools to streamline the process!',
    image: '/images/enganging video.webp',
    readTime: '6 min read',
    link: 'https://writetechhub.org/how-to-create-engaging-video-tutorials-for-technical-content/',
    linkText: 'Read more',
    category: ['blogs', 'tutorials'],
    tags: ['tools', 'video'],
  ...
  // API Documentation & Specialization
  {
    ...
    description: 'Comprehensive documentation on a Task Tracker Project',
    image: '/images/aws-waf.webp',
    readTime: '10 min read',
    link: 'https://task-manager-api-documentation.vercel.app/',
    linkText: 'Read more',
    category: ['apiDocs'],
  ...
  // Content for Brands
  {
    ...
    title: 'What Nigerian Businesses Gain When WHT Compliance Goes Fully Digital',
    description: 'For many Nigerian businesses, withholding tax compliance has always brought stress. It takes time, involves several authorities, and requires careful recordkeeping.',
    image: '/images/brand-content-1.jpg',
    readTime: '5 min read',
    link: 'https://omassociates.com.ng/what-nigerian-businesses-gain-when-wht-compliance-goes-fully-digital/',
    linkText: 'Read more',
    category: ['contentForBrands'],
    tags: ['WHT App', 'Finance', 'Technical Writing'],
    featured: false,
  ...
  {
    id: 'cfo-tool',
    title: 'The CFO’s New Tool: Why Finance Leaders Are Turning to the WHT Application for Strategic Compliance',
    description: 'For years, finance leaders in Nigeria have treated withholding tax (WHT) compliance as a necessary but routine task. It sat at the bottom of the priority list, handled quietly by back-office teams. As long as filings were made and receipts collected, many CFOs rarely paid attention.',
    image: '/images/startups.webp',
    readTime: '6 min read',
    link: 'https://omassociates.com.ng/the-cfos-new-tool-why-finance-leaders-are-turning-to-the-wht-application-for-strategic-compliance/',
    linkText: 'Read more',
  ...
  },
  {
    ...
    title: 'The Essential Requirements to Start and Run a Compliant MSME in Nigeria',
    description: 'Starting a business in Nigeria is not difficult. Many people open shops, offer services, or begin small operations with little to no paperwork. But running a compliant business is a different story. Compliance is what separates informal hustles from real, sustainable businesses. It gives your business the structure, recognition, and access it needs to grow.',
    image: '/images/startups.webp',
    readTime: '6 min read',
    link: 'https://omassociates.com.ng/the-essential-requirements-to-start-and-run-a-compliant-msme-in-nigeria/',
    linkText: 'Read more',
    category: ['contentForBrands', 'finance'],
    tags: ['CFO', 'Consulting', 'Startups'],
    companyName: 'O.M Associates',
